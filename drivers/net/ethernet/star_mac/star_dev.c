...
#if defined (CONFIG_ARCH_MT5396) || defined(CONFIG_ARCH_MT5368) || defined(CONFIG_ARCH_MT5389) || defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5880)||defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5882)
        // configure LED 
        StarMdcMdioWrite(dev, starPrv->phy_addr, 0x1f, 0x0002); //misc page
...
//#elif defined (CONFIG_ARCH_MT5389)
		...
		StarMdcMdioWrite(dev, starPrv->phy_addr, 0x1F, 0x0000);  // main page
#elif defined (CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5882)
        StarMdcMdioWrite(dev, starPrv->phy_addr, 0x1F, 0x2a30);  // test page
        //msleep(50);
      ...
      StarMdcMdioWrite(dev, starPrv->phy_addr, 0x1F, 0x2a30);  // test page
      data = StarMdcMdioRead(dev, starPrv->phy_addr, 0x15);
      data = (data & 0xff00) |((0x2f & 0x7f)<< 0);//100M slew rate
      StarMdcMdioWrite(dev, starPrv->phy_addr, 0x15, data);  // 100M slew rate
      StarMdcMdioWrite(dev, starPrv->phy_addr, 0x1F, 0x0000);  // main page
...
{    
...
#elif defined (CONFIG_ARCH_MT5398) || defined (CONFIG_ARCH_MT5880)||defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5882)
    ...
    */
    ...
    msleep(50);
#endif    
#if defined(CONFIG_ARCH_MT5880)||defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5882)
